  ...
  <div class="footer-main">
    <div class="container">
      <div class="row">
        ...
        <div class="col-sm-6 col-md-3">
          <div class="footer-links">
            <h3 class="footer-brand mb-2">PESOJobPortal</h3>
            <div class="footer-link-list">
             <a href="#" class="footer-links"><i class="fas fa-compass"></i>Tabuk City Kalinga</a>
             <a href="tel:98400001511" class="footer-links"><i class="fas fa-phone"></i> 000000000</a>
             <a href="tel:98400001511" class="footer-links"><i class="fas fa-mobile"></i> 00000000000</a>
             <a href="mailto:info@joblister.com" class="footer-links"><i class="fas fa-envelope"></i> peso@admin.com</a>
             <div class="social-links">
               <a href="https://www.facebook.com/PESO.TabukCity" target="_blank" class="social-link"><i class="fab fa-facebook"></i></a>
