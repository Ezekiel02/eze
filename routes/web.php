...
use App\Http\Controllers\EmployeReqController;
...
Route::middleware('auth')->prefix('account')->group(function () {
  ...
  Route::get('home', [AccountController::class, 'indexView'])->name('index');
  ...
  Route::group(['middleware' => ['role:user']], function () {
    ...
    // Route::resource('employereq','EmployeReqController');
  });
});
